...
//function ShowArcellormittal() {
//    let HTML = ''
//    var menuCode = 'arcellormittal';
//    $.ajax({
//        async: false,
//        type: "POST",
//        url: "/Astep/loadMenu",
...
function DisplayArcellorMenu(code) {
    ...
    $('#arcellor_grid_card').empty().append(html);
}
